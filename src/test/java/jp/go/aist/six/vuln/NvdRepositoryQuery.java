...
//  SIX-2014-0022 5.0
    ...
    public static Collection<QueryParamsAndCount> vulnIdPatternParamsAndCount()
    {
        Collection<QueryParamsAndCount>  params_list = new ArrayList<QueryParamsAndCount>();
        for (PatternAndCount  pattern_and_count : VULN_ID_PATTERNS_AND_COUNTS) {
            VulnerabilityQueryParams  params = new VulnerabilityQueryParams();
            params.setId( pattern_and_count.pattern );

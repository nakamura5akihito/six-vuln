 ...
 * @version $Id: AccessComplexityType.java 529 2013-04-15 07:08:54Z nakamura5akihito@gmail.com $
 */
...
//    private AccessComplexityEnumType  content;
                    ...
                    )
    {
        if (content != null) {
            // validation
            AccessComplexityEnumType.valueOf( content );
        }
    ...
    public static boolean approximated(
                    final AccessComplexityType obj
//                    final VectorAttributeGroup vectorAttributeGroup
                    ...
                    )
    {
        ...
        if (!(obj instanceof AccessComplexityType)) {
            return false;
        }

        final AccessComplexityType  other = (AccessComplexityType)obj;
    ...
    {
        return "AccessComplexityType[approximated=" + isApproximated()
                        + ", content=" + getContent()
                        + "]";
    }

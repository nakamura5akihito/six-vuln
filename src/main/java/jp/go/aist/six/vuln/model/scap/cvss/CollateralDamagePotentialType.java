 ...
 * @version $Id: CollateralDamagePotentialType.java 529 2013-04-15 07:08:54Z nakamura5akihito@gmail.com $
 */
...
//    private CollateralDamagePotentialEnumType  content;
                    ...
                    )
    {
        if (content != null) {
            // validation
            CollateralDamagePotentialEnumType.valueOf( content );
        }
    ...
    public static boolean approximated(
                    final CollateralDamagePotentialType obj
//                    final VectorAttributeGroup vectorAttributeGroup
                    ...
                    )
    {
        ...
        if (!(obj instanceof CollateralDamagePotentialType)) {
            return false;
        }

        final CollateralDamagePotentialType  other = (CollateralDamagePotentialType)obj;
    ...
    {
        return "CollateralDamagePotentialType[approximated=" + isApproximated()
                        + ", content=" + getContent()
                        + "]";
    }

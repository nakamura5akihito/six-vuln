 ...
 * @version $Id: ConfidenceType.java 529 2013-04-15 07:08:54Z nakamura5akihito@gmail.com $
 */
...
//    private ConfidenceEnumType  content;
                    ...
                    )
    {
        if (content != null) {
            // validation
            ConfidenceEnumType.valueOf( content );
        }
...
//                    final VectorAttributeGroup vectorAttributeGroup
                    ...
                    )
    {
        ...
        if (!(obj instanceof ConfidenceType)) {
            return false;
        }

        final ConfidenceType  other = (ConfidenceType)obj;
    ...
    {
        return "ConfidenceType[approximated=" + isApproximated()
                        + ", content=" + getContent()
                        + "]";
    }

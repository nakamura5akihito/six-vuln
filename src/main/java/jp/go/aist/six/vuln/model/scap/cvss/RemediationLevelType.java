 ...
 * @version $Id: RemediationLevelType.java 529 2013-04-15 07:08:54Z nakamura5akihito@gmail.com $
 */
...
//    private RemediationLevelEnumType  content;
                    ...
                    )
    {
        if (content != null) {
            // validation
            RemediationLevelEnumType.valueOf( content );
        }
    ...
    public static boolean approximated(
                    final RemediationLevelType obj
//                    final VectorAttributeGroup vectorAttributeGroup
                    ...
                    )
    {
        ...
        if (!(obj instanceof RemediationLevelType)) {
            return false;
        }

        final RemediationLevelType  other = (RemediationLevelType)obj;
    ...
    {
        return "RemediationLevelType[approximated=" + isApproximated()
                        + ", content=" + getContent()
                        + "]";
    }

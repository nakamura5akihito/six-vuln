 ...
 * @version $Id: AuthenticationType.java 529 2013-04-15 07:08:54Z nakamura5akihito@gmail.com $
 */
...
//    private AuthenticationEnumType  content;
                    ...
                    )
    {
        if (content != null) {
            // validation
            AuthenticationEnumType.valueOf( content );
        }
...
//                    final VectorAttributeGroup vectorAttributeGroup
                    ...
                    )
    {
        ...
        final AuthenticationType  other = (AuthenticationType)obj;
    ...
    {
        return "AuthenticationType[approximated=" + isApproximated()
                        + ", content=" + getContent()
                        + "]";
    }

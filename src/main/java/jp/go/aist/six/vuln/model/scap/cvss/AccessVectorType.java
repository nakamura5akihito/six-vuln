 ...
 * @version $Id: AccessVectorType.java 529 2013-04-15 07:08:54Z nakamura5akihito@gmail.com $
 */
...
//    private AccessVectorEnumType  content;
                    ...
                    )
    {
        if (content != null) {
            // validation
            AccessVectorEnumType.valueOf( content );
        }
...
//                    final VectorAttributeGroup vectorAttributeGroup
                    ...
                    )
    {
        ...
        if (!(obj instanceof AccessVectorType)) {
            return false;
        }

        final AccessVectorType  other = (AccessVectorType)obj;
    ...
    {
        return "AccessVectorType[approximated=" + isApproximated()
                        + ", content=" + getContent()
                        + "]";
    }
